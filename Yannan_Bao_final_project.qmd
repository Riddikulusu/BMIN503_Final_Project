...
#add district geometry to avg_mortality
...
1)\~2)The comparison of the mortality and accessibility maps indicates that districts with high hospital accessibility do not align with low mortality rates. This complex spatial relationship suggests that factors other than hospital accessibility may be the primary drivers of mortality, potentially contradicting an initial hypothesis.

3)The annual mortality rate line charts reveal substantial structural differences between districts. Additionally, all districts were simultaneously affected by significant temporal shocks (e.g., the sharp rise around 2020, likely attributable to COVID-19).
...
The Descriptive analysis indicates that Between-District variation is substantial, while Within-District variation is much smaller. This suggests that structural differences between districts are the primary drivers of the observed variance. Consequently, the modeling approach should prioritize the analysis of these structural, between-district differences, while also incorporating the effects of dynamic temporal shocks to get more accurate results.
